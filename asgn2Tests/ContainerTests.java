...
public class ManifestTests {
	...
	public void testToArray() {
		// valid cases
		FreightContainer[] containers;
		try {
			containers = manifest.toArray(new Integer(0));
			assertTrue(containers[0].equals(ggContainers[0]));
			assertTrue(containers[1].equals(ggContainers[1]));
			
			containers = manifest.toArray(new Integer(1));
			assertTrue(containers[0].equals(dgContainers[0]));
			assertTrue(containers[1].equals(dgContainers[1]));
			
			containers = manifest.toArray(new Integer(2));
			assertTrue(containers[0].equals(rContainers[0]));
			assertTrue(containers[1].equals(rContainers[1]));
		} catch (ManifestException e) {
			fail(e.getMessage());
		}
	...
	public void testToString() {
		String expected = 
				"|| INKU2633836 || KOCU8090115 ||\n" + 
				"|| MSCU6639871 || CSQU3054389 ||\n" +
				"|| QUTU7200318 || IBMU4882351 ||\n";
		...
		expected = 
				...
				"|| MSCU6639871 ||*CSQU3054389*||\n" +
				"|| QUTU7200318 || IBMU4882351 ||\n";
		assertEquals(expected, manifest.toString(cc[3]));
	}
}
